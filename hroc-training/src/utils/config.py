...
class SignalConfig:
    ...
    hreflex_ms: tuple = (8.0, 10.0)     # spinal reflex latency


@dataclass
class DataConfig:
    zarr_path: str = ""                  # set by Tarun once real Zarr exists
    use_synthetic: bool = True           # True => run end-to-end with no real data
    n_trials_synthetic: int = 12000      # ~ scaled down Animal 9 (~95k real)
    batch_size: int = 128
